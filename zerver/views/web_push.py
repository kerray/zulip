...
from zerver.lib.typed_endpoint_validators import check_https_url
...
def add_web_push_subscription(
    ...
    *,
    ...
    p256dh_key: Annotated[str, StringConstraints(max_length=255)],
    auth_secret: Annotated[str, StringConstraints(max_length=255)],
